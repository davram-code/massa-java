...
public class MassaProperties {
    ...
    public int getRootCaValidityYears(){
        return Integer.parseInt(properties.getProperty("massa.root-ca-validity-years"));
    }


    public String getRootCaName(){
        return properties.getProperty("massa.root-ca-name");
    }
