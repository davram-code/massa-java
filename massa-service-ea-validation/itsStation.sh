...
curl -X GET \
	--silent \
	http://localhost:8080/massa/enrollment/probe
echo ""

echo -n "Checking Authorization Service availability: "
curl -X GET \
	--silent \
	http://localhost:8080/massa/authorization/probe
echo ""
...
curl -X POST \
	...
	http://localhost:8080/massa/enrollment
...
curl -X POST \
	...
	http://localhost:8080/massa/authorization
